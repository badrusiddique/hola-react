    ...
    <div className="flex justify-center">
      <div className="bg-gray-300 h-36 w-2xl m-4 rounded-lg">
        ...
        <div className="flex justify-left pl-4">
          ...
          <div className="text-orange-500">
            <input type="checkbox" checked={includeNum} onChange={(e) => setIncludeNum(e.target.checked)}></input>
            <label className="p-2">Include numbers</label>
          </div>
          <div className="text-orange-500">
            <input type="checkbox" checked={includeSpecialChar} onChange={(e) => setIncludeSpecialChar(e.target.checked)}></input>
